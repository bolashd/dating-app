...
public class AppDbContext(DbContextOptions options) : IdentityDbContext<AppUser>(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        .HasData(
            new IdentityRole() { Id = "member-id", Name = "Member", NormalizedName = "MEMBER", ConcurrencyStamp = "member-id" },
            new IdentityRole() { Id = "moderator-id", Name = "Moderator", NormalizedName = "MODERATOR", ConcurrencyStamp = "moderator-id" },
            new IdentityRole() { Id = "admin-id", Name = "Admin", NormalizedName = "ADMIN", ConcurrencyStamp = "admin-id" }
        );
        ...
        var nullableDateTimeConverter = new ValueConverter<DateTime?, DateTime?>(v => v.HasValue ? v.Value.ToUniversalTime() : null, v => v.HasValue ? DateTime.SpecifyKind(v.Value, DateTimeKind.Utc) : null);
